...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet("pages/NhanDangTraiCay/yolov8n_trai_cay.onnx")
    print(st.session_state["LoadModel"])
    print('Load model lần đầu') 

filename_classes = 'pages/NhanDangTraiCay/object_detection_trai_cay_yolo.txt'
my_width=640
my_height=640

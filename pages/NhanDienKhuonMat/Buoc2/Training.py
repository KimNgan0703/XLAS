...
detector = cv2.FaceDetectorYN.create(
    "pages/NhanDienKhuonMat/model/face_detection_yunet_2023mar.onnx",
    "",
    (320, 320),
    0.9,
    0.3,
...
recognizer = cv2.FaceRecognizerSF.create(
            "pages/NhanDienKhuonMat/model/face_recognition_sface_2021dec.onnx","")


metadata = load_metadata('pages/NhanDienKhuonMat/image')
...
joblib.dump(svc,'pages/NhanDienKhuonMat/model/svc.pkl')
